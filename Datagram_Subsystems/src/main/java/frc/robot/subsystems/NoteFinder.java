...
public class NoteFinder extends SubsystemBase {
  ...
  private synchronized void parseBuffer2() {
    ...
    firstString = stringBuilder.substring(1, stringBuilder.insideOf("]"));
    secondString = stringBuilder.substring(stringBuilder.insideOf("|") + 2, stringBuilder.lastIndexOf(("]")));
    thirdString = stringBuilder.substring(stringBuilder.insideOf("\"") + 3, stringBuilder.lastIndexOf("\""));
