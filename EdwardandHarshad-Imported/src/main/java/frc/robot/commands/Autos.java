...
public final class Autos {
  ...
  public static Command driveStraightByTime(Drivetrain drivetrain, long millisecondsToDrive) {
    return new DriveStraight(drivetrain, millisecondsToDrive);
  }

  public static Command driveStraightByDistance(Drivetrain drivetrain, double distanceToDrive) {
    return new DriveStraightEncoder(drivetrain, distanceToDrive);
  }

  public static Command turn(Drivetrain drivetrain, double targetAngleDegrees) {
    return new Turn(drivetrain, targetAngleDegrees);
  }

  public static Command createPIDTurn(Drivetrain drivetrain, double targetAngleDegrees) {
    return new PIDTurn(drivetrain, targetAngleDegrees);
  }
   public static Command createHealthToPhysicsAndBackAgain(Drivetrain drivetrain)
    {
