...
public class PIDTurn extends PIDCommand {
  ...
  public PIDTurn(Drivetrain drivetrain, double targetAngleDegrees) {
   ...
   /**
    * Want to be sure we zero our gyro, so, overriding iniyialize().
    ...
    *the compiler will flag the error in thhe class.
    */
    @Override
    public void initialize() {
       make sure the parent gets to do their tasks. If we dont 
